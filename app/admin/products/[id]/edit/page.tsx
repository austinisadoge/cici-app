    ...
    fetch(`/api/admin/products/${id}`)
      ...
      .then(d => {
        ...
        setInitial({
          ...
          spec_zh: p.spec_zh ?? '', spec_en: p.spec_en ?? '',
          color_zh: p.color_zh ?? '', color_en: p.color_en ?? '',
          occasion_zh: p.occasion_zh ?? '', occasion_en: p.occasion_en ?? '',
          technique_zh: p.technique_zh ?? '', technique_en: p.technique_en ?? '',
          size_zh: p.size_zh ?? '', size_en: p.size_en ?? '',
          material_zh: p.material_zh ?? '', material_en: p.material_en ?? '',
          care_zh: p.care_zh ?? '', care_en: p.care_en ?? '',
